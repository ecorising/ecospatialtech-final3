...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <header className="bg-white text-black px-4 py-2 flex justify-between items-center font-sans">
      ...
      <main className="font-sans bg-gray-100 min-h-screen">{children}</main>
      <footer className="bg-gray-200 text-center py-6 mt-16 text-sm font-sans">
