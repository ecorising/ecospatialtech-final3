...
export default function Home() {
  return (
    <Layout>
      <section className="relative w-full h-[600px] font-sans">
        <img
          src="/images/hero-drone-satellite.jpg"
          alt="Drone and satellite observing Earth"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-6 bg-black bg-opacity-40 text-white">
