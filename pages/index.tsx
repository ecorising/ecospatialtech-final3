...
export default function Home() {
  return (
    <Layout>
      <section className="relative w-full min-h-[80vh] font-sans">
  <img
    src="/images/hero-drone-satellite.jpg"
    alt="Drone and satellite observing Earth"
    className="absolute inset-0 w-full h-full object-cover z-0"
  />
  <div className="relative z-10 flex flex-col justify-center items-center text-center px-6 py-24 bg-black/50 text-white">
